...
namespace Base
{
    ...
    */
    ...
    public:
        ...
        typedef void (*destructTypeMethod)(void);
        ...
        static const Type createType(const Type parent, const char* name, instantiationMethod method = 0,
                                     Type::destructTypeMethod destruct = 0);
    ...
    private:
        ...
        // MSVC: warning C4251, needs to have dll-interface to be used by clients of class 'Base::Type'
