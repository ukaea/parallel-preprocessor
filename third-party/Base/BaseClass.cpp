...
void BaseClass::init(void)
{
    ...
    BaseClass::classTypeId =
        Type::createType(Type::badType(), "Base::BaseClass", BaseClass::create, BaseClass::destructType);
}

void BaseClass::destructType(void)
{
    BaseClass::classTypeId = Type::badType();
}
...
void BaseClass::initSubclass(Base::Type& toInit, const char* ClassName, const char* ParentName,
                             Type::instantiationMethod method, Type::destructTypeMethod destruct)
{
    // don't init twice!
