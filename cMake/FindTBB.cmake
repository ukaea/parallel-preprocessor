...
#  ENV TBB_ROOT_DIR or just TBB_ROOT_DIR - root directory of tbb installation
#  ENV TBB_BUILD_PREFIX - specifies the build prefix for user built tbb
#                         libraries. Should be specified with ENV TBB_ROOT_DIR
#                         and optionally...
#  ENV TBB_BUILD_DIR - if build directory is different than ${TBB_ROOT_DIR}/build
#
#
...
getenv_path(TBB_ROOT_DIR)

# initialize search paths
set(TBB_PREFIX_PATH   ${TBB_ROOT_DIR} ${ENV_TBB_ROOT_DIR})
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  set(TBB_DEFAULT_SEARCH_DIR "C:/Program Files/Intel/TBB"
                            "C:/Program Files (x86)/Intel/TBB"
                            "D:/Software/OpenCASCADE-7.4.0-vc14-64/tbb_2017.0.100"
                            )
  list(APPEND TBB_PREFIX_PATH  ${TBB_DEFAULT_SEARCH_DIR})                
endif()
...
if (TBB_BUILD_PREFIX AND ENV_TBB_ROOT_DIR)
  getenv_path(TBB_BUILD_DIR)
  if (NOT ENV_TBB_BUILD_DIR)
    set(ENV_TBB_BUILD_DIR ${ENV_TBB_ROOT_DIR}/build)
  endif ()

  # include directory under ${ENV_TBB_ROOT_DIR}/include
...
if (WIN32 AND MSVC)
  ...
  elseif((MSVC_VERSION EQUAL 1900)  OR (MSVC_VERSION GREATER 1900)) #  vs2015, 17 19
    set(COMPILER_PREFIX "vc14")
  # future ABI change, it could be vc15
  endif ()
